...
const FAQS = [
  ...
  { q: '¿Cuántos archivos debo subir?', a: 'Debes subir exactamente 7 archivos de lecturas y 7 archivos de facturación: 6 meses de evaluación más 1 mes histórico anterior. El mes histórico es necesario para que el motor pueda calcular el primer par de lecturas periódicas consecutivas.' },
  { q: '¿En qué orden debo subir los archivos?', a: 'No importa el orden en que los subas. El sistema ordena automáticamente los archivos por fecha antes de procesarlos, garantizando que la ventana de 6 meses se calcule correctamente desde el mes más reciente hacia atrás.' },
]
